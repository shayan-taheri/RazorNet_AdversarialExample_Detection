...
fig = plt.figure()
plt.imshow(xorg)
plt.savefig('/home/USER_NAME/PycharmProjects/attack_suite/img/original_cifar.png')
...
fig = plt.figure()
plt.imshow(X_adv)
plt.savefig('/home/USER_NAME/PycharmProjects/attack_suite/img/xadvs_cw_cifar.png')
