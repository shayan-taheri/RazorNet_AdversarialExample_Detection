...
for ib in range(0,len(NumNonTrainable)):
    ...
    model = DenseNet(reduction=0.5, classes=classes, NumNonTrainable=NumNonTrainable[ib])
    ...
    f = open("/home/shayan/Codes/DenseNet-Keras-master/Stat_PillNoKnowledge_" + str(ib) + ".txt", "w")
