...
for i1 in range(000,250):
    if i1 < 10:
        ...
        for filename in glob.glob('/home/shayan/Biometric_Datasets/Iris/Real/' + '0' + str(i1) + '/L/*.jpg'):
            im=cv2.imread(filename)
            X_train.append(im)
            Y_train.append([0])
    else:
...
for i4 in range(000,100):
    if i4 < 10:
        for filename in glob.glob('/home/shayan/Biometric_Datasets/Fingerprint/True/' + '00' + str(i4) + '/R/*.bmp'):
            im=cv2.imread(filename)
            X_train.append(im)
            Y_train.append([3])
    elif (i4 >= 10) & (i4 < 100):
        for filename in glob.glob('/home/shayan/Biometric_Datasets/Fingerprint/True/' + '0' + str(i4) + '/R/*.bmp'):
            im=cv2.imread(filename)
            X_train.append(im)
            Y_train.append([3])
    else:
