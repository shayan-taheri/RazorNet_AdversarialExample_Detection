...
@tf_export(v1=['layers.MaxMinConvolution2D'])
...
@deprecation.deprecated(
    ...
    instructions='Use keras.layers.MaxMinconv2d instead.')

@tf_export(v1=['layers.MaxMinconv2d'])

def MaxMinconv2d(inputs,
